  ...
  return (
    <div className="rounded-lg hover:shadow-xl transition-opacity bg-white overflow-hidden shadow-lg">
      <Image
        width={100}
        height={"200"}
        className="h-48 w-full object-cover object-center" src="https://images.ctfassets.net/mmeshd7gafk1/d0605b78c85d3b0b09a9dcc76d28fd93-meta-526-276/235d1caf12a040da70d5ea6a07b5bb5a/Locked_Banner_meta.png" alt="Product Image" />
