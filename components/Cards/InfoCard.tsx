    ...
    <div className='my-14 px-4 w-full max-w-6xl mx-auto'>
      <div className="relative my-10 mx-auto flex flex-col justify-between  px-10 lg:max-w-screen-lg lg:flex-row">
        ...
        <div className="relative py-10 ">
          ...
          <Link href={link}>
          <button type="button" className="mt-4 flex items-center justify-center w-full rounded-lg border border-primary px-5 py-2.5 text-xs font-medium text-primary hover:bg-slate-200 focus:outline-none focus:ring-4  focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
