...
const ProductCard = () => {
  return (
    <div className="rounded-lg hover:shadow-xl transition-opacity bg-white p-4 shadow-lg">
      ...
      <a href="#" className="text-sm font-semibold leading-tight text-gray-900 hover:underline dark:text-white">Apple iMac 27``, 1TB HDD, Retina 5K Display, M3 Max</a>
      ...
      <ul className="mt-2 flex items-center gap-4">
        <li className="flex items-center gap-2">
          ...
          <p className="text-xs font-medium text-gray-500 dark:text-gray-400">Fast Delivery</p>
        </li>
        ...
        <li className="flex items-center gap-2">
          ...
          <p className="text-xs font-medium text-gray-500 dark:text-gray-400">Best Price</p>
        </li>
      </ul>

      <div className="mt-4 flex items-center justify-between gap-4">
        <p className="text-lg font-extrabold leading-tight text-gray-900 dark:text-white">$1,699</p>
