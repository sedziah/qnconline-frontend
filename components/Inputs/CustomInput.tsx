...
const CustomInput = ({ labal, onChange, value, placeholder, type, required = false }: PropType) => {
  return (
    <div className="relative">
      <input value={value} onChange={onChange} type={type} id={labal} className="block rounded-lg px-2.5 pb-2 pt-5 w-full text-sm text-black border hover:bg-lightGray/20 border-lightGray appearance-none focus:outline-none focus:ring-0 focus:border-lightGray peer" placeholder={placeholder} required={required} />
