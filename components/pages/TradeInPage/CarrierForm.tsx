...
const carrierOptions = [
  ...
  },
  {
    label: "Verizon",
    image:
      "https://pentagram-production.imgix.net/ba1eda20-927e-47ad-882b-037993fb348a/mb_verizon_01.jpg?crop=edges&fit=crop&h=630&rect=337%2C0%2C3834%2C2400&w=1200",
  },
  {
    label: "T-Mobile",
    image:
      "https://www.gsma.com/solutions-and-impact/connectivity-for-good/external-affairs/wp-content/uploads/2022/05/T-Mobile_New_Logo_Primary_RGB_M-on-W.jpg",
  },
  {
    label: "Sprint",
    image:
      "https://upload.wikimedia.org/wikipedia/commons/6/6f/Sprint_Corporation_Logo.svg",
  },
  { label: "Other" },
];
    ...
    <div style={{ ...ANIMATIONSTYLE }} className="w-full transition">
        ...
        >
          ...
          <div className="w-full">
            ...
            <p className="text-black text-[13px] font-normal my-5">
              A locked phone has a software code that restricts it to one
              carrier while unlocked phones work with any carrier.
            </p>
      ...
      <div className="my-7">
        <div className="grid grid-cols-2 gap-x-5">
          {carrierOptions.map((carrier, index) => (
            <button
              key={carrier.label}
              onClick={() => setSelectedOption(carrier.label)}
      ...
      >
        <button
          onClick={() => {
            if (selectedOption) {
              handleNext({ label: "Carrier", value: selectedOption });
            }
          }}
