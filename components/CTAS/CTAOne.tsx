...
export const CTAOne = () => {
  return (
    <div className='w-full max-w-6xl mx-auto'>
      <div className='mx-4 flex flex-row items-center justify-between lg:mx-0 md:mx-4 bg-lightGray/20 p-6 rounded-lg'>
        <div className=' flex flex-row capitalize items-center gap-x-2'>
